...
namespace Content.Client.Imperial.ImperialStore.Ui.Withdraw;
...
public sealed partial class ImperialStoreWithdrawWindow : DefaultWindow
{
    [Dependency] private readonly IPrototypeManager _prototypeManager = default!;

    private Dictionary<ImperialCurrencyPrototype, FixedPoint2> _validCurrencies = new();
    private HashSet<CurrencyWithdrawButton> _buttons = new();
    public event Action<BaseButton.ButtonEventArgs, string, int>? OnWithdrawAttempt;

    public ImperialStoreWithdrawWindow()
    {
        RobustXamlLoader.Load(this);
        IoCManager.InjectDependencies(this);
    }

    public void CreateCurrencyButtons(Dictionary<ProtoId<ImperialCurrencyPrototype>, FixedPoint2> balance)
    {
        ...
        {
            if (!currency.Key.CanWithdraw) continue;
            ...
            var button = new CurrencyWithdrawButton()
            {
                ...
                MinHeight = 20,
                Text = Loc.GetString(currency.Key.DisplayName),
