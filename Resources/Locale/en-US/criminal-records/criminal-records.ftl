...
criminal-records-console-records-list-title = Records
...
criminal-records-console-reason-placeholder = Enter here

## Crime History

criminal-records-console-crime-history = Crime History
criminal-records-history-placeholder = Write the crime here
criminal-records-no-history = This persons's record is spotless.
