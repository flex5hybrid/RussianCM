ent-RMCExplosiveBreachingCharge-name = breaching charge
ent-RMCExplosiveBreachingCharge-desc = An explosive device used to break into areas while protecting the user from the blast as well as deploying deadly shrapnel on the other side.
