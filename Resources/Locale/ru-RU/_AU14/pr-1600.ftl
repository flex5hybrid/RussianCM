...
au14-analyzer-banked-items = Анализатор принял { $amount } ед. «{ $name }». (до следующего очка: { $banked }/{ $required })
au14-analyzer-credited-cash-progress = Анализатор начислил CLF { $points } очк. (накоплено кредитов: { $banked }/{ $required })
