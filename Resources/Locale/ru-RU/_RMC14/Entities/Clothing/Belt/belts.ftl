ent-RMCBeltSPPBrown = пояс боеприпасов схемы 6B80
...
ent-RMCM82FHolster = пояс для сигнального пистолета M82F схемы M276
...
ent-RMCM82FHolsterFilled = разгрузка сигнального пистолета M82F схемы M276
  .desc = M276 — стандартное снаряжение для переноски грузов КМП. Состоит из модульного пояса с различных зажимов. Эта версия предназначена для ракетницы M82F и дополнительно может хранить до 16 ракет.
...
ent-RMCBeltHolsterM13 = кобура для M13 схемы M276
...
ent-RMCBeltXM51 = кобура для XM51 схемы M276
...
ent-RMCMatebaBeltLuxurious = роскошный пояс для Матебы схемы M276
...
ent-RMCMatebaBelt = кобура для Матеба схемы M276
...
ent-RMCMatebaBeltFilled = кобура для Матеба схемы M276
  .desc = M276 — стандартное снаряжение для переноски грузов КМП. Состоит из модульного пояса с различных зажимов. Эта версия предназначена для мощного револьвера Mateba Magnum, вместе с пятью малыми подсумками для обойм. Она входила в комплект заказанной по почте редакции Mateba autorevolver от КМП в начале 2110-х.

ent-RMCBeltHolsterSMGPouch = кобура для M39 схемы M276
...
ent-RMCBeltUtilityGeneral =  пояс общего доступа схемы M276 G8-A
...
ent-RMCBeltHolsterSMG = кобура для M39, схемы M276
  .desc = Специальный вариант M276, предназначенный для ношения пистолета-пулемёта M39.
ent-RMCBeltHolsterRevolver = кобура для револьвера схемы M276
...
ent-RMCBeltHolsterPistolSPP = пистолетная кобура типа 47-S
...
ent-RMCBeltHolsterPistol = пистолетная кобура схемы M276
...
ent-RMCBeltGrenadeLarge = пояс для гранат M40 схемы M276 Мк. II
  .desc = M276 Мк. II — улучшенная версия разгрузки для гранат M276 с большей вместимостью.
ent-RMCBeltGrenade = пояс для гранат M40 схемы M276
...
ent-RMCBeltPMC = пояс боеприпасов схемы M305
...
ent-RMCM276ShotgunShellLoadingRig = пояс для патронов дробовика схемы M276
  .desc = Пояс для боеприпасов, предназначенный для патронов дробовика.
ent-CMBeltMarine = пояс боеприпасов схемы M276
...
ent-CMBeltUtilityFilled = набор инструментов схемы М276
 .desc = M276 — стандартное снаряжение для переноски грузов КМП. Состоит из модульного пояса с различными зажимами. Оно состоит из модульного ремня с различными креплениями. Эта версия не предназначена для использования в боевых условиях и обычно используется инженерами для транспортировки важных инструментов.
