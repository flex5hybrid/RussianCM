...
ent-RMCJumpsuitSPPArmy = SPP army fatigues
  .desc = A set of SPP fatigues, mass produced for the Armed Collective of the Socialitsts Progressive Peoples. A rare sight, especially in TSE zones. This particular set sports the standard SPP pattern of the SPP Army's 202nd Infantry Regiment.
