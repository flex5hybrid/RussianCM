...
ent-WeaponRifleXM88 = Тяжелая винтовка XM88
  .desc = Экспериментальная переносная противоматериальная винтовка под патрон .458 SOCOM. Перед каждым выстрелом необходимо вручную досылать патрон в патронник.
