...
ent-RMCD18Case = D18 pistol case
  .desc = A fairly decorated and sturdy box containing a D18 Hummingbird and a single additional magazine for it. If the gun doesn't make you feel secure, the box sure does.
...
ent-RMCM59ACaseAP = M59A prototype rifle AP case
  .desc = A gun case containing the M59A prototype rifle loaded with AP rounds. Experimental and back issue only, built to outperform the standard M54C. While this case contains MK1 rifle magazines, the weapon also supports MK2 rifle magazines.
...
ent-RMCML66DCase = ML66D heavy machine gun case
  .desc = A gun case containing the ML66D heavy machine gun. Comes with 2 magazines
ent-RMCM2CCase = M2C heavy machine gun case
  .desc = A gun case containing the M2C heavy machine gun. Comes with 4 magazines
