...
ent-CMDrinkCanBeerLite = We-Ya Lite
  .desc = Beer. You've dialed in your target. Time to fire for effect. Canned by the Weston-Yamada Corporation
ent-CMDrinkCanAle = We-Ya IPA
  .desc = Beer's misunderstood cousin. Canned by the Weston-Yamada Corporation.
