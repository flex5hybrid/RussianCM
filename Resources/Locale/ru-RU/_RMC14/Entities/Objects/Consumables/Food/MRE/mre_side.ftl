...
ent-CMMREComponentCracker = MRE component (cracker)
  .desc = An MRE side component. Contains a side, to be eaten alongside the main. This one is a cracker.
...
ent-CMMREFoodCracker = cracker
  .desc = The contents of a Marine Standard issue MRE. This one is a cracker.
ent-CMMREFoodRiceOnigiri = rice onigiri
  .desc = The contents of a Marine Standard issue MRE. This one is rice onigiri.
ent-CMMREFoodMashedPotatoes = mashed potatoes
  .desc = The contents of a Marine Standard issue MRE. This one is mashed potatoes.
ent-CMMREFoodRisotto = risotto
  .desc = The contents of a Marine Standard issue MRE. This one is risotto.
