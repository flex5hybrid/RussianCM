...
ent-RMCMREComponentMeatzels = MRE component (meatzels)
  .desc = An MRE snack component. Contains a light snack in case you weren't feeling terribly hungry. This one is.. meatzels ?
...
ent-CMMREFoodBiscuit = biscuit
  .desc = The contents of a Marine Standard issue MRE. This one is a biscuit.
ent-CMMREFoodMeatballs = meatballs
  .desc = The contents of a Marine Standard issue MRE. This one is meatballs.
ent-RMCMREFoodMeatzels = meatzels
  .desc = The contents of a Marine Standard issue MRE. This one is.. meatzels ?
ent-CMMREFoodPretzels = pretzels
  .desc = The contents of a Marine Standard issue MRE. This one is pretzels.
ent-CMMREFoodPeanuts = peanuts
  .desc = The contents of a Marine Standard issue MRE. This one is peanuts.
ent-CMMREFoodSushi = sushi
  .desc = The contents of a Marine Standard issue MRE. This one is sushi.
