...
rmc-ui-audio-voicelines-arachnid = Реплики арахнидов
rmc-ui-audio-voicelines-diona = Реплики диона
rmc-ui-audio-voicelines-dwarf = Реплики дварфов
rmc-ui-audio-voicelines-felinid = Реплики фелинидов
rmc-ui-audio-voicelines-human = Реплики людей
rmc-ui-audio-voicelines-moth = Реплики молей
rmc-ui-audio-voicelines-reptilian = Реплики рептилий
rmc-ui-audio-voicelines-slime = Реплики слизей
rmc-ui-audio-voicelines-avali = Реплики авали
rmc-ui-audio-voicelines-vulpkanin = Реплики вульпканинов
...
rmc-ui-audio-emotes-diona = Эмоции диона
rmc-ui-audio-emotes-dwarf = Эмоции дварфов
rmc-ui-audio-emotes-felinid = Эмоции фелинидов
rmc-ui-audio-emotes-human = Эмоции людей
rmc-ui-audio-emotes-moth = Эмоции молей
rmc-ui-audio-emotes-reptilian = Эмоции рептилий
rmc-ui-audio-emotes-slime = Эмоции слизей
rmc-ui-audio-emotes-avali = Эмоции авали
rmc-ui-audio-emotes-vulpkanin = Эмоции вульпканинов
...
rmc-ui-named-items-displayed-as = Будет отображаться как 'Ваше имя' Штурмовая винтовка M54C.
  ...
  Если сомневаетесь, спросите в AHelp! (F1)
rmc-ui-named-primary-gun = Имя основного оружия
rmc-ui-named-sidearm = Имя пистолета
...
rmc-ui-lobby-message-description = Отображается игрокам перед началом игры.
  Выбирается случайно среди всех патронов этого уровня.
  Убедитесь, что сообщение не нарушает правила.
  Если сомневаетесь, спросите в AHelp! (F1)
rmc-ui-shoutout = Благодарность в конце раунда
rmc-ui-shoutout-marine-title = Имя для морпехов в конце раунда
rmc-ui-shoutout-marine-description = Отображается как спонсор операции.
rmc-ui-shoutout-xeno-title = Имя для ксеносов в конце раунда
rmc-ui-shoutout-xeno-description = Отображается как основатель улья.
rmc-ui-shoutout-example = Пример:
rmc-ui-shoutout-info = Каждое имя выбирается случайно среди патронов уровня.
  Убедитесь, что имена соответствуют игре и не нарушают правила.
  Если сомневаетесь, спросите в AHelp! (F1)
rmc-ui-named-items-in-preferences = Имена предметов можно изменить в настройках персонажа.
rmc-ui-figurine = Фигурка персонажа
rmc-ui-figurine-in-preferences = Вы можете экспортировать персонажа для создания фигурки в настройках.
  Одна активная фигурка на человека!
  Для изменений обратитесь в Discord.
