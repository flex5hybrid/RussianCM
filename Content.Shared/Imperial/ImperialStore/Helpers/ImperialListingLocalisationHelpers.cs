...
public static partial class ImperialListingLocalisationHelpers
{
    /// <summary>
    ...
    /// </summary>
    public static string GetLocalisedNameOrEntityName(ImperialListingData listingData, IPrototypeManager prototypeManager)
    {
    ...
    /// </summary>
    public static string GetLocalisedDescriptionOrEntityDescription(ImperialListingData listingData, IPrototypeManager prototypeManager)
    {
