...
public sealed partial class CEVehicleComponent : Component
{
    /// <summary>
...
public enum CEVehicleVisuals : byte
{
...
public readonly record struct CEOnVehicleEnteredEvent(Entity<CEVehicleComponent> Vehicle, EntityUid Operator);
...
/// </summary>
[ByRefEvent, UsedImplicitly]
public readonly record struct CEOnVehicleExitedEvent(Entity<CEVehicleComponent> Vehicle, EntityUid Operator);
...
/// </summary>
[ByRefEvent, UsedImplicitly]
public readonly record struct CEVehicleOperatorSetEvent(EntityUid? NewOperator, EntityUid? OldOperator);

/// <summary>
/// Event raised on a vehicle to check if it can run/move around.
/// </summary>
[ByRefEvent, UsedImplicitly]
public record struct CEVehicleCanRunEvent(Entity<CEVehicleComponent> Vehicle, bool CanRun = true);
