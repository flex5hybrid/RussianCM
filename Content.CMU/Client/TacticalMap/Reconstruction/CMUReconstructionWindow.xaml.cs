...
public sealed partial class CMUReconstructionWindow : RMCPopOutWindow
{
    protected override Control Control => ContentPanel;
    ...
    public override void Close()
    {
        ...
        // A pop-out temporarily orphans the content before closing this shell.
        if (IsOpen && ContentPanel.Parent != null) OnClosing?.Invoke();
        base.Close();
    }
